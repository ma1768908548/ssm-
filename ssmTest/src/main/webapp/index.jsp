                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="email" class="form-control" id="email_update_input"
                                       placeholder="email@majingjing.com">
...
<script type="text/javascript">
    ...
    //this.getClass().getResource("/ssmTest").getPath();
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.code == 100) {
                    ...
                    $("#emp_save_btn").attr("ajax-va", "success");//自定义一个属性
                } else {
    ...
    $(document).on("click", ".delete_btn", function () {
        ...
        //console.log("员工名字"+empName);
        if (confirm("确认删除" + empName + "吗？")) {
            //确认 发送ajax请求 确认即可
            $.ajax({
                url: "<%=request.getContextPath()%>/emp/" + $(this).attr("delete-id"),
                type: "DELETE",
                success: function (result) {
                    alert(result.msg);
                    //回到本页
